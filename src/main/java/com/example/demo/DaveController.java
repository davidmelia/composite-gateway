...
public class DaveController {
  ...
  public Mono<CustomerAddressesViewModel> melia(@Parameter(hidden = true) ProxyExchange<AddressSearchResults> addressProxy, @Parameter(hidden = true) ProxyExchange<Customer> customerProxy) {
  ...
  public Mono<AddressSearchResults> proxyAddresses(@Parameter(hidden = true) ProxyExchange<AddressSearchResults> proxyExchange1) {
  ...
  public Mono<CustomerAddressesViewModel> proxyAddresseForward(@Parameter(hidden = true) ProxyExchange<AddressSearchResults> addressProxy,
  ...
  public Mono<Customer> proxyCustomer(@Parameter(hidden = true) ProxyExchange<Customer> proxyExchange1) {
